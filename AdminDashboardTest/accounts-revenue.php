...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($invoice_date)) {
        $sql = "INSERT INTO revenue (invoiced_by, invoice_date, amount_paid, note, type)
                VALUES (?, ?, ?, ?, ?)";
...
<body>
    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="recent-orders">
                ...
                <button id="openrevenueModalBtn">Add Revenue</button>
    ...
    <script>
        ...
        var receivableBtn = document.getElementById("openrevenueModalBtn");
