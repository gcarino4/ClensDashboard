                    ...
                    while ($row_revenue = $result_revenue->fetch_assoc()) {
                        if ($current_type_revenue != $row_revenue['type']) {
                            if ($current_type_revenue !== null) {
                                ...
                                echo "<tr><td colspan='4' style='padding: 8px; text-align: right; font-weight: bold; background-color: #e9e9e9;'>Total: " . number_format($type_total_revenue, 2) . "</td></tr>";
                        ...
                        $type_total_revenue += $row_revenue['amount_paid'];
